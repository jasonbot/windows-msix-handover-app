...
func (this *IMdmAlert) Put_Data(value string) {
	_hr, _, _ := syscall.SyscallN(this.Vtbl().Put_Data, uintptr(unsafe.Pointer(this)), winrt.NewHStr(value).Ptr)
	_ = _hr
}
...
func (this *IMdmAlert) Put_Source(value string) {
	_hr, _, _ := syscall.SyscallN(this.Vtbl().Put_Source, uintptr(unsafe.Pointer(this)), winrt.NewHStr(value).Ptr)
	_ = _hr
}
...
func (this *IMdmAlert) Put_Target(value string) {
	_hr, _, _ := syscall.SyscallN(this.Vtbl().Put_Target, uintptr(unsafe.Pointer(this)), winrt.NewHStr(value).Ptr)
	_ = _hr
}
...
func (this *IMdmAlert) Put_Type(value string) {
	_hr, _, _ := syscall.SyscallN(this.Vtbl().Put_Type, uintptr(unsafe.Pointer(this)), winrt.NewHStr(value).Ptr)
	_ = _hr
}
...
type IMdmSessionInterface interface {
	win32.IInspectableInterface
	Get_Alerts() *winrt.IVectorView[*IMdmAlert]
	Get_ExtendedError() winrt.HResult
	Get_Id() string
	Get_State() MdmSessionState
	AttachAsync() *winrt.IAsyncAction
	Delete()
	StartAsync() *winrt.IAsyncAction
	StartWithAlertsAsync(alerts *winrt.IIterable[*IMdmAlert]) *winrt.IAsyncAction
}
...
func (this *IMdmSession) Get_Alerts() *winrt.IVectorView[*IMdmAlert] {
	var _result *winrt.IVectorView[*IMdmAlert]
...
func (this *IMdmSession) Get_ExtendedError() winrt.HResult {
...
func (this *IMdmSession) AttachAsync() *winrt.IAsyncAction {
...
func (this *IMdmSession) StartAsync() *winrt.IAsyncAction {
	var _result *winrt.IAsyncAction
...
func (this *IMdmSession) StartWithAlertsAsync(alerts *winrt.IIterable[*IMdmAlert]) *winrt.IAsyncAction {
	var _result *winrt.IAsyncAction
...
type IMdmSessionManagerStaticsInterface interface {
	win32.IInspectableInterface
	Get_SessionIds() *winrt.IVectorView[string]
...
func (this *IMdmSessionManagerStatics) Get_SessionIds() *winrt.IVectorView[string] {
	var _result *winrt.IVectorView[string]
...
func (this *IMdmSessionManagerStatics) DeleteSessionById(sessionId string) {
	_hr, _, _ := syscall.SyscallN(this.Vtbl().DeleteSessionById, uintptr(unsafe.Pointer(this)), winrt.NewHStr(sessionId).Ptr)
	_ = _hr
}

func (this *IMdmSessionManagerStatics) GetSessionById(sessionId string) *IMdmSession {
	var _result *IMdmSession
	_hr, _, _ := syscall.SyscallN(this.Vtbl().GetSessionById, uintptr(unsafe.Pointer(this)), winrt.NewHStr(sessionId).Ptr, uintptr(unsafe.Pointer(&_result)))
	_ = _hr
	com.AddToScope(_result)
	return _result
}
...
func NewMdmAlert() *MdmAlert {
	hs := winrt.NewHStr("Windows.Management.MdmAlert")
...
func NewIMdmSessionManagerStatics() *IMdmSessionManagerStatics {
	...
	hs := winrt.NewHStr("Windows.Management.MdmSessionManager")
