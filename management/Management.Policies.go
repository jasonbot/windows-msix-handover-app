...
type INamedPolicyDataInterface interface {
	...
	Get_User() *winrt.IUser
	GetBoolean() bool
	GetBinary() *winrt.IBuffer
	GetInt32() int32
	GetInt64() int64
	GetString() string
	Add_Changed(changedHandler winrt.TypedEventHandler[*INamedPolicyData, interface{}]) winrt.EventRegistrationToken
	Remove_Changed(cookie winrt.EventRegistrationToken)
}
...
func (this *INamedPolicyData) Get_User() *winrt.IUser {
	var _result *winrt.IUser
...
func (this *INamedPolicyData) GetBinary() *winrt.IBuffer {
	var _result *winrt.IBuffer
...
func (this *INamedPolicyData) Add_Changed(changedHandler winrt.TypedEventHandler[*INamedPolicyData, interface{}]) winrt.EventRegistrationToken {
	var _result winrt.EventRegistrationToken
	_hr, _, _ := syscall.SyscallN(this.Vtbl().Add_Changed, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(winrt.NewTwoArgFuncDelegate(changedHandler))), uintptr(unsafe.Pointer(&_result)))
	_ = _hr
	return _result
}

func (this *INamedPolicyData) Remove_Changed(cookie winrt.EventRegistrationToken) {
...
type INamedPolicyStaticsInterface interface {
	...
	GetPolicyFromPathForUser(user *winrt.IUser, area string, name string) *INamedPolicyData
}
...
func (this *INamedPolicyStatics) GetPolicyFromPath(area string, name string) *INamedPolicyData {
	...
	_hr, _, _ := syscall.SyscallN(this.Vtbl().GetPolicyFromPath, uintptr(unsafe.Pointer(this)), winrt.NewHStr(area).Ptr, winrt.NewHStr(name).Ptr, uintptr(unsafe.Pointer(&_result)))
	_ = _hr
	com.AddToScope(_result)
	return _result
}

func (this *INamedPolicyStatics) GetPolicyFromPathForUser(user *winrt.IUser, area string, name string) *INamedPolicyData {
	var _result *INamedPolicyData
	_hr, _, _ := syscall.SyscallN(this.Vtbl().GetPolicyFromPathForUser, uintptr(unsafe.Pointer(this)), uintptr(unsafe.Pointer(user)), winrt.NewHStr(area).Ptr, winrt.NewHStr(name).Ptr, uintptr(unsafe.Pointer(&_result)))
	_ = _hr
	com.AddToScope(_result)
	return _result
}
...
func NewINamedPolicyStatics() *INamedPolicyStatics {
	...
	hs := winrt.NewHStr("Windows.Management.Policies.NamedPolicy")
